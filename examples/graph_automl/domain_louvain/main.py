...
if __name__ == "__main__":
    ...
    def evaluate_pipeline(tune_mode=args.tune_mode, pipeline_planer=pipeline_planer):
        ...
        for run_idx in range(args.num_runs):
            ...
            model = Louvain(resolution=args.resolution)
            ...
            run_details.append({
                ...
                "seed": current_seed,
                "ari": float(score),
                "inner_score": float(run_inner_score),
        ...
        # ================= JSON 记录逻辑开始 =================
        dataset_key = args.sample_number

        experiment_summary = {
            "timestamp": time.strftime("%Y-%m-%d %H:%M:%S"),
            "hyperparameters": dict(wandb.config) if wandb.config else {},
            "runs": run_details,
            "avg_ari": float(avg_score),
            "avg_inner_score": float(avg_inner_score),
...
$ python main.py --sample_number 151673 --resolution 1.0 --tune_mode params

human dorsolateral prefrontal cortex sample 151676:
$ python main.py --sample_number 151676 --resolution 1.0 --tune_mode params

human dorsolateral prefrontal cortex sample 151507:
$ python main.py --sample_number 151507 --resolution 1.0 --tune_mode params
"""
